...
public class RingProgressIndicator extends ProgressCircleIndicator {
    ...
    public void setRingColor(String color) {
        // Code pour définir la couleur de l'anneau
        // Par exemple, vous pouvez ajouter une classe CSS avec cette couleur
        String css = String.format("-fx-ring-color: %s;", color);
        this.setStyle(css);
    }
}
